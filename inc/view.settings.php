...
<fieldset>
  ...
  <ul class="thethe-settings-list">
   <li>
      <label for="data-en_s"><?php _e('Character CAPTCHA','light-captcha')?>:</label>
      ...
      <label for="data-en_m"><?php _e('Mathematical CAPTCHA','light-captcha')?>:</label>
...
<fieldset>
  ...
  <ul class="thethe-settings-list">
	...
	<li>
      <label for="data-w3_font_size_max">???????????? ?????? ???????:</label>
	...
	<li>
      <label for="data-w3_char_angle_min">???????????? ?????? ??????? ?????:</label>
	 ...
	 <li>
      <label for="data-w3_char_angle_max">???????????? ?????? ??????? ??????:</label>
	...
	<li>
      <label for="data-w3_char_angle_shadow">?????? ????:</label>
...
<?php
	...
	<img src="'.WP_PLUGIN_URL.'/light-captcha/style/images/reload.png" id="reload_captcha_math" alt="CAPTCHA Reload" title="'.'__("Generate new CAPTCHA","light-captcha")'.'"/>
	<br />
	';
?>
<fieldset>
